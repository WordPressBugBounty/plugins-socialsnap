...
class SocialSnap_MashShare_Compatibility {
	...
	public function migrate_settings() {
		...
		wp_send_json_success( array( 'message' => esc_html__( 'MashShare settings imported successfully.', 'socialsnap' ) ) );
	}
	...
	public function migrate_shares() {
		...
		// Send success message.
		wp_send_json_success( array( 'message' => esc_html__( 'MashShare share counts imported successfully.', 'socialsnap' ) ) );
	}
